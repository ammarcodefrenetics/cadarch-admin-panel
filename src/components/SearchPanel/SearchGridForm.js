...
export default function SearchGridForm({ defaultvalues, searchPanelParams, onChange, Apply, onAddNew, ToggleButton, MenuBtnRef, ...props }) {
                ...
                searchPanelParams ?
                    <div className={classes.searchPanel} >
                        <NewGrid item container direction="row" lg={12}>
                            ...
                            <NewGrid item container justify="flex-start" direction="row" xs={12} sm={4} md={3} lg={3}>
                            ...
                            <Popover
                                ...
                                <form onSubmit={onApply}>
                                    ...
                                    <div className={classes.footerButton}>
                                        <FormBtn id="save" type="submit" size="medium">
                                            Apply
                                        </FormBtn >
